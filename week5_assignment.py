...
#       card_number = '4567' + random.sample(range(33, 70), 6) + datetime.now().strftime('%Y%m%d')
...
#     def __repr__(self):
#       return f'Card Details(number = {self.card_number}\n Expiray date = {self.expiration_date}\
#         \n Securit Code = {self.security_code})'
